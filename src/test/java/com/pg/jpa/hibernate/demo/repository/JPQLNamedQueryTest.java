...
public class JPQLNamedQueryTest {
    ...
    public void jpql_basic() {
        List resultList =  manager.createNamedQuery("query_get_all_courses").getResultList();
    ...
    public void jpql_typed() {
        TypedQuery<Course> query = manager.createNamedQuery("query_get_all_courses", Course.class); //Use the NamedQuery to test below
    ...
    public void jpql_typed_with_where_clause() {
        TypedQuery<Course> query = manager.createNamedQuery("query_get_all_peters_courses", Course.class);
        List resultList = query.getResultList();
